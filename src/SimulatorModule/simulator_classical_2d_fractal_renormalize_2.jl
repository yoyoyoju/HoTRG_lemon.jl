...
##### bug fixing: newCore with mirrored
...
function calculateNextCoreTensor{T}(tensorT::Array{T,4}, tensorTtilde::Array{T,4}, dimM::Int; mirror = false)
	...
	newTensorT = getNewTensorT(tensorT,tensorUl, mirror = mirror)
	newTensorTtilde = getNewTensorT(tensorT,tensorUl,tensorTtilde, mirror = mirror)
